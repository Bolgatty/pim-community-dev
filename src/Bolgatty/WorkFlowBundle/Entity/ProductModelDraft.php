...
class ProductModelDraft implements EntityWithValuesDraftInterface
{
    ...
    /**
     * Set entityWithValues.
     *
     * @param \Akeneo\Pim\Enrichment\Component\Product\Model\ProductModel $entityWithValues
     *
     * @return ProductModelDraft
     */
    public function setEntityWithValues(\Akeneo\Pim\Enrichment\Component\Product\Model\ProductModel $entityWithValues)
    {
        $this->entityWithValues = $entityWithValues;
    ...
    /**
     * Get entityWithValues.
     *
     * @return \Akeneo\Pim\Enrichment\Component\Product\Model\ProductModel
     */
