...
class ProductDraft implements EntityWithValuesDraftInterface
{
     ...
     *
     * @param \Akeneo\Pim\Enrichment\Component\Product\Model\Product $entityWithValues
     *
     * @return ProductDraft
     */
    public function setEntityWithValues(\Akeneo\Pim\Enrichment\Component\Product\Model\Product $entityWithValues)
    {
        $this->entityWithValues = $entityWithValues;
     ...
     *
     * @return \Akeneo\Pim\Enrichment\Component\Product\Model\Product
     */
