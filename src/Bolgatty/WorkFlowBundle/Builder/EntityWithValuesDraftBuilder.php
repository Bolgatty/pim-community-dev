<?php
namespace Bolgatty\WorkFlowBundle\Builder;
...
class EntityWithValuesDraftBuilder implements EntityWithValuesDraftBuilderInterface
{
     ...
     * {@inheritdoc}
     */
    public function build($entityWithValues, DraftSource $draftSource): ?EntityWithValuesDraftInterface
    {
    ...
    protected function getEntityWithValuesDraft($entityWithValues, DraftSource $draftSource): EntityWithValuesDraftInterface
    {
    ...
    protected function getOriginalValues($entityWithValues): array
    {
