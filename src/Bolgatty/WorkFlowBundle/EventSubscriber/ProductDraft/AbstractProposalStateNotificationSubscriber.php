...
abstract class AbstractProposalStateNotificationSubscriber
{
    ...
    protected function buildNotificationMessageInfos(GenericEvent $event, $type)
    {
        ...
        $messageInfos = [
            'message' => sprintf('bolgatty_workflow.product_draft.notification.%s', $type),
            'context' => [
                'actionType' => sprintf('bolgatty_workflow_product_draft_notification_%s', $type)
            ]
        ];
        ...
        if (count($updatedValues) > self::NOTIFICATION_MAX_ATTRIBUTES) {
            $messageInfos['message'] = sprintf('bolgatty_workflow.product_draft.notification.%s_number', $type);
        ...
        $messageInfos['message'] = sprintf('bolgatty_workflow.product_draft.notification.%s', $type);
