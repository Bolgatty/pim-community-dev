...
class ApproveNotificationSubscriber extends AbstractProposalStateNotificationSubscriber implements EventSubscriberInterface
{
    ...
    {
        // dump("reached here", $this->isEventValid($event));die;
        // if (!$this->isEventValid($event)) {
        //     return;
        // }
    ...
    protected function send(GenericEvent $event, array $messageInfos)
    {
        ...
        $message = isset($messageInfos['message'])
            ...
            : 'bolgatty_workflow.product_draft.notification.approve';
        ...
        $options = [
            ...
            'context'       => [
                'actionType'       => 'bolgatty_workflow_product_draft_notification_approve',
