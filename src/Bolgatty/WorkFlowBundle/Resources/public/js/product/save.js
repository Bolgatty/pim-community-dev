    ...
    function (
        ...
        return Save.extend({
            ...
            render: function () {
                ...
                if (!isOwner) {
                    this.updateSuccessMessage = _.__('bolgatty_workflow.entity.product_draft.flash.update.success');
                    this.updateFailureMessage = _.__('bolgatty_workflow.entity.product_draft.flash.update.fail');
                }
